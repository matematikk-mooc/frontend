...
if(!redirected) {
  ...
  if (design !== undefined && design=="udir") {
      if(this.udirDesignLoaded === undefined)
      {
          ...
          var filename = 'https://kompetanseudirno.azureedge.net/udirdesign/mmooc-min-Hollendaren_1.3_uob.css';
          ...
          fileref.onload = (_) => {
            $.getScript('https://kompetanseudirno.azureedge.net/udirdesign/mmooc-min-Hollendaren_1.3_uob.js');
          }
...
//# sourceMappingURL=rootaccount-Hollendaren_1.3_uob.js.map