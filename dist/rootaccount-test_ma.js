...
if(!redirected) {
  ...
  if (design !== undefined && design=="udir") {
      if(this.udirDesignLoaded === undefined)
      {
          ...
          var filename = 'https://kompetanseudirno.azureedge.net/udirdesign-staging/mmooc-min-test_ma.css';
          ...
          fileref.onload = (_) => {
            $.getScript('https://kompetanseudirno.azureedge.net/udirdesign-staging/mmooc-min-test_ma.js');
          }
...
//# sourceMappingURL=rootaccount-test_ma.js.map