...
if(!redirected) {
  ...
  if (design !== undefined && design=="udir") {
      if(this.udirDesignLoaded === undefined)
      {
          ...
          var filename = 'https://kompetanseudirno.azureedge.net/udirdesign/mmooc-min-KURSP-642-ready-for-kpas-php-8.css';
          ...
          fileref.onload = (_) => {
            $.getScript('https://kompetanseudirno.azureedge.net/udirdesign/mmooc-min-KURSP-642-ready-for-kpas-php-8.js');
          }
...
//# sourceMappingURL=rootaccount-KURSP-642-ready-for-kpas-php-8.js.map