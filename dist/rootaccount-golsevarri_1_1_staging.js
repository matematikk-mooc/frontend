...
if(!redirected) {
  ...
  if (design !== undefined && design=="udir") {
      if(this.udirDesignLoaded === undefined)
      {
          ...
          var filename = 'https://kompetanseudirno.azureedge.net/udirdesign-staging/mmooc-min-golsevarri_1_1_staging.css';
          ...
          fileref.onload = (_) => {
            $.getScript('https://kompetanseudirno.azureedge.net/udirdesign-staging/mmooc-min-golsevarri_1_1_staging.js');
          }
...
//# sourceMappingURL=rootaccount-golsevarri_1_1_staging.js.map