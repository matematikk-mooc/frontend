...
if(!redirected) {
  ...
  if (design !== undefined && design=="udir") {
      if(this.udirDesignLoaded === undefined)
      {
          ...
          var filename = 'https://kompetanseudirno.azureedge.net/udirdesign/mmooc-min-kursp-642.css';
          ...
          fileref.onload = (_) => {
            $.getScript('https://kompetanseudirno.azureedge.net/udirdesign/mmooc-min-kursp-642.js');
          }
...
//# sourceMappingURL=rootaccount-kursp-642.js.map