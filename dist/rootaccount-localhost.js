      ...
      if(!document.location.search.includes("normalLogin=1")) {
        ...
        <div class="login-box frontPageLoginBox">
          ...
          <div class="unitPartners">
            <a href="https://udir.no" target="_blank"><img class="unitPartnersUdirLogo unitPartnersLogo" src="http://localhost:9000/bitmaps/udirlogo50px.png"/></a>
            <a href="https://ntnu.no" target="_blank"><img class="unitPartnersSmallLogo" src="http://localhost:9000/bitmaps/logo_ntnu.png"/></a>
            <a href="https://unit.no" target="_blank"><img class="unitPartnersUnitLogo" src="http://localhost:9000/bitmaps/unit-logo-farge.svg"/></a>
          </div>
        </div>
        `;
  ...
  setTimeout(function() {
    if(!$(".ic-DashboardCard__header_hero").length) {
      ...
      <h3>Er det tomt her?</h3>
        ...
        <img src="http://localhost:9000/bitmaps/nyinnlogging.png" width="70%" alt="Ny innloggingsskjerm"/>
      </div>
      `;
...
//# sourceMappingURL=rootaccount-localhost.js.map