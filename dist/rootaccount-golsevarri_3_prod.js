...
if(!redirected) {
  ...
  if (design !== undefined && design=="udir") {
      if(this.udirDesignLoaded === undefined)
      {
          ...
          var filename = 'https://kompetanseudirno.azureedge.net/udirdesign/mmooc-min-golsevarri_3_prod.css';
          ...
          fileref.onload = (_) => {
            $.getScript('https://kompetanseudirno.azureedge.net/udirdesign/mmooc-min-golsevarri_3_prod.js');
          }
...
//# sourceMappingURL=rootaccount-golsevarri_3_prod.js.map