...
if (typeof this.mmooc.i18n === 'undefined') {
  if (mmooc.api.getLocale() == 'nn') {
    this.mmooc.i18n = {
      ...
      YouAreRegisteredToXCourses: amount => `du er registerd in ${amount} Emne`,
      ...
      NoEnrollments:
        'Velkommen til vår emneplattform. Du er ikkje påmeldt nokon emne endå. Klikk på knappen nedanfor for å sjå tilgjengelege emne.',
      OutOf: 'av',
      Months: [
        'januar',
        'februar',
    ...
    this.mmooc.i18n = {
      ...
      CourseRegister: 'Registrere',
      CourseRegisterFeide: 'Registrere med Feide',
      YouAreRegisteredToXCourses: amount => `du er registerd in ${amount} Emner`,
      CoursesAmount: amount => `${amount} kurs`,
      OpenCoursesGroup: 'Utsikt',
      CloseCoursesGroup: 'Lukke',
      LogIn: 'Logg inn',
      ...
      NoTeacherFeedbackLink:
        'No teacher_feedback link. Does the help menu have a link to send feedback to the teacher?',
      NoEnrollments:
        'Velkommen til vår emneplattform. Du er ikke påmeldt noen emner enda. Klikk på knappen nedenfor for å se tilgjengelige emner.',
      OutOf: 'av',
      Months: [
        'januar',
        'februar',
