                ...
                */
                function uiofixpage() {
                    ...
                    if (pagetitle) {
                        ...
                        //KURSP-109 
                        //Vi skjuler brødsmulestien så denne koden kan sannsynligvis fjernes
                ...
                let tooltips = document.querySelectorAll('div.tooltiptext');
                for (let i = 0; i < tooltips.length; i++) {
                    tooltips[i].innerHTML = uioMakeSpans(tooltips[i]);
                }
                let moduleNames = document.querySelectorAll('a.mmooc-module-name');
